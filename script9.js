...
(function getData(){
    ...
    request.onload = () =>{
        if(request.status===200){
            data = JSON.parse(request.response).slice(80,90)
            ...
            for(var i=0;i<13;i++){
                ...
                if(i===0){
                    ...
                    pagNavItems[i].innerHTML = `<a class="page-link" href="page8.html" tabindex="-1"> < </a>`
                }
                else if(i===2){
                    ...
                    pagNavItems[i].innerHTML = `<a class="page-link" href="page10.html" tabindex="-1"> > </a>`
                }
                else{

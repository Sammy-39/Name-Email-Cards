...
(function getData(){
    ...
    request.onload = () =>{
        if(request.status===200){
            data = JSON.parse(request.response).slice(30,40)
            ...
            for(var i=0;i<13;i++){
                ...
                if(i===0){
                    ...
                    pagNavItems[i].innerHTML = `<a class="page-link" href="page3.html" tabindex="-1"> < </a>`
                }
                else if(i===2){
                    ...
                    pagNavItems[i].innerHTML = `<a class="page-link" href="page5.html" tabindex="-1"> > </a>`
                }
                else{

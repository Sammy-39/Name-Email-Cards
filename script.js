...
(function getData(){
    ...
    request.onload = () =>{
        if(request.status===200){
            data = JSON.parse(request.response).slice(0,10)
            ...
            for(var i=0;i<5;i++){
                ...
                setAttributes(colElements["R"+(i+1)][0],{
                    class:"col col-sm-6 col-md-6 col-lg-6 col-xl-6"
                })
            ...
            for(var i=0;i<13;i++){
                ...
                if(i===0){
                    ...
                    pagNavItems[i].classList.add("disabled")
                    pagNavItems[i].innerHTML = `<a class="page-link" href="#" tabindex="-1"> < </a>`
                }
                else if(i===2){
                    ...
                    pagNavItems[i].innerHTML = `<a class="page-link" href="page2.html" tabindex="-1"> > </a>`
                }
                else{
